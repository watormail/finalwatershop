...
@Service
public class NewBeeMallGoodsServiceImpl implements GoodsService {
    ...
    public NewBeeMallGoods getNewBeeMallGoodsById(Long id) {
        return goodsMapper.findById(id).get();
    }

    @Override
    public PageResult searchNewBeeMallGoods(PageQueryUtil pageUtil) {
        List<NewBeeMallGoods> goodsList = goodsMapper.query(pageUtil);
