...
public interface UserTokenDao extends JpaRepository<MallUserToken,Long>, JpaSpecificationExecutor<MallUserToken>, Serializable {
...
//    int updateByPrimaryKey(MallUserToken record);
    ...
    //按照token查询应有值
    MallUserToken findByToken(String token);
}